# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/02_layers_neural_spline.ipynb.

# %% auto 0
__all__ = ['DEFAULT_MIN_BIN_WIDTH', 'DEFAULT_MIN_BIN_HEIGHT', 'DEFAULT_MIN_DERIVATIVE', 'NeuralSpline', 'ConditionalNeuralSpline',
           'TransformNet', 'ConvResidualBlock', 'ConvResidualNet', 'unconstrained_rational_quadratic_spline',
           'rational_quadratic_spline', 'searchsorted', 'sum_except_batch', 'is_nonnegative_int']

# %% ../../nbs/02_layers_neural_spline.ipynb 3
from fastai.vision.all import nn, torch, np
from torch.nn import functional as F, init

# %% ../../nbs/02_layers_neural_spline.ipynb 4
DEFAULT_MIN_BIN_WIDTH = 1e-2
DEFAULT_MIN_BIN_HEIGHT = 1e-2
DEFAULT_MIN_DERIVATIVE = 1e-2

# %% ../../nbs/02_layers_neural_spline.ipynb 5

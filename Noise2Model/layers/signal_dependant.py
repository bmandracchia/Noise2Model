# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/02_layers_signal_dependant.ipynb.

# %% auto 0
__all__ = ['DEFAULT_MIN_BIN_WIDTH', 'DEFAULT_MIN_BIN_HEIGHT', 'DEFAULT_MIN_DERIVATIVE', 'SignalDependant', 'SignalDependantExp2',
           'SignalDependantNS']

# %% ../../nbs/02_layers_signal_dependant.ipynb 3
from fastai.vision.all import nn, torch, np
from .neural_spline import (unconstrained_rational_quadratic_spline, \
                                            rational_quadratic_spline, sum_except_batch)


# %% ../../nbs/02_layers_signal_dependant.ipynb 4
...
# %% ../../nbs/02_layers_signal_dependant.ipynb 6
DEFAULT_MIN_BIN_WIDTH = 1e-3
DEFAULT_MIN_BIN_HEIGHT = 1e-3
DEFAULT_MIN_DERIVATIVE = 1e-3


# %% ../../nbs/02_layers_signal_dependant.ipynb 7
